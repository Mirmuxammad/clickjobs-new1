...
class ResumeVC: UIViewController {
    ...
    @IBOutlet weak var experienceView: SSNeumorphicView!{
        didSet{
            addSSNeumorphicView(vieww: experienceView)
        }
    }
    
    
    @IBOutlet weak var WorkViewww: SSNeumorphicView!{
        didSet{
         addSSNeumorphicView(vieww: WorkViewww)
        }
    }
